...
@section('title', __('Daily journal'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered text-nowrap border-bottom" id="daily-journal-datatable">
                                <thead>
                                    <tr>
...
@push('plugin-scripts')
    ...
    <script>
        $(function() {
            $('#daily-journal-datatable').DataTable({
                language: {
