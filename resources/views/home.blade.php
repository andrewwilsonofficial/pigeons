...
@section('content')
    ...
    <div class="main-container container-fluid">
        <div class="row">
            @if ($plan_subscription_requests->count() > 0)
                <div class="col-12 text-center mt-3">
                    <h4 class="text-danger">
                        {{ __('You have pending subscription requests, please wait until the admin approve it') }}
                    </h4>
                </div>
                @foreach ($plan_subscription_requests as $plan_subscription_request)
                    <div class="alert alert-info col-12 text-center text-dark mt-3">
                        <i class="fa fa-info-circle"></i>
                        {{ __('Request no.') }} #{{ $plan_subscription_request->id }},
                        {{ __('Plan') }}: {{ $plan_subscription_request->plan->name }}
            ...
            <div class="col-12 text-center">
                ...
                @else
                    <img src="{{ asset('assets/images/pigeon-sad.png') }}" alt="Map Pigeon" width="300"
                        class="img-fluid">
                    <h4 class="mt-3">
                        {{ __('You do not have any active subscription') }}
                    </h4>
                    <hr style="border: 2px solid grey; width: 50%; margin: 20px auto; border-radius: 5px;">
                    <div class="row">
                            ...
                            <div class="col-md col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('plans.subscribe', $plan->id) }}" class="btn btn-primary">
                                            {{ __('Subscribe') }}
                                            <i class="fa fa-arrow-right"></i>
                                        </a>
                                    </div>
